...
<script>
  import { MolgenisFormGenerator, FormComponent } from './molgenisUiForm'
  ...
  export default {
    ...
    created () {
      const form = MolgenisFormGenerator.generateForm(EntityTypeV2Response.metadata, EntityTypeV2Response.items)
